...
public class FileEx {
    public static void main(String[] args) throws IOException {
        ...
        File folder=new File("D:\\MyLABS\\JaBa\\java-courses2");
        File file2=new File("test20.txt");
        File folder2=new File("D:\\MyLABS\\JaBa\\java-courses2\\A");
        File file3=new File("\\test30.txt");
